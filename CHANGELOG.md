<a id="v2.3.2"></a>
# [v2.3.2](https://github.com/thombashi/DateTimeRange/releases/tag/v2.3.2) - 2025-11-14

## What's Changed
* Add support for Python 3.14
* Handle `ValueError` in datetime formatting methods
* Bump the actions-dependencies group across 1 directory with 5 updates by [@dependabot](https://github.com/dependabot)[bot] in [#56](https://github.com/thombashi/DateTimeRange/pull/56)


**Full Changelog**: https://github.com/thombashi/DateTimeRange/compare/v2.3.1...v2.3.2
...
[v2.3.2]: https://github.com/thombashi/DateTimeRange/compare/v2.3.1...v2.3.2
